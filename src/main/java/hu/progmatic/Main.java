...
public class Main {
  ...
  public static void teszAdatok(Videoteka videoteka){
    ...
    videoteka.addFilm(new RomantikusFilm("S125R", "Elfújta a szél", 1939, "Romantikus", 7200, 100_000_000));
    ...
    videoteka.addFilm(new HorrorFilm("S129H","Az",2017,"Horror",8200,35_000_000));
  ...
  public static void Menu(Videoteka videoteka) {
    ...
    do {
      ...
      System.out.println("6. Filmek listázása, amelyekben kötettek házasságok");
      System.out.println("***************************************************");
